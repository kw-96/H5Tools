...
> A powerful Figma plugin for rapid H5 campaign prototyping and multi-channel adaptation, designed for designers and product teams.
...
2. 安装 [Figma Desktop App](https://www.figma.com/downloads/)
3. 克隆本项目并安装依赖：
   ```bash
...
- **主要依赖**：TypeScript、ESLint、Figma Plugin API
...
<details>
<summary>插件无法加载图片怎么办？</summary>
<p>请检查图片格式是否为 PNG、JPG 或 WEBP，图片大小不要超过 10MB。</p>
</details>

<details>
<summary>创建的原型在哪里查看？</summary>
<p>原型会直接在 Figma 画布中生成，请检查当前页面或新创建的页面。</p>
</details>

<details>
<summary>如何保存我的配置？</summary>
<p>目前配置会自动保存在浏览器本地，未来版本将支持配置文件导出。</p>
</details>

<details>
<summary>插件卡顿怎么办？</summary>
<p>请尝试重启插件，或者刷新 Figma 页面。如果问题持续存在，请联系技术支持。</p>
</details>

<details>
<summary>能否添加自定义模块？</summary>
<p>当前版本暂不支持自定义模块，但我们计划在后续版本中添加此功能。</p>
</details>
