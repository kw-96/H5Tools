...
export class H5PrototypeBuilder {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.config.pageBgImage) {
                ...
                if (bgImageData) {
                    ...
                    const bgImageNode = yield ImageNodeBuilder.insertImage(this.config.pageBgImage, "页面背景图片");
                    if (bgImageNode) {
                        // 水平居中容器，顶部对齐容器顶部
    ...
    addModules() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // 创建所有模块
            const modules = yield this.createAllModules();
            // 批量安全添加模块到H5画板中
    ...
    createHeaderModuleIfNeeded() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.config.headerImage || this.config.titleUpload) {
                const module = yield createHeaderModule(this.config.headerImage, this.config.titleUpload);
                if (module) {
                    return module;
                }
            }
    ...
    createGameInfoModuleIfNeeded() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.config.gameName || this.config.gameDesc || this.config.gameIcon) {
                const module = yield createGameInfoModule(this.config);
                return module;
            }
            return null;
        });
    ...
    createRulesModuleIfNeeded() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (hasRulesTitle || hasRulesBgImage || hasRulesContent) {
                const module = yield createRulesModule(this.config);
                return module;
            }
            return null;
        });
     ...
     */
    createFooterModuleIfNeeded() {
        return __awaiter(this, void 0, void 0, function* () {
            // 检查是否需要创建底部模块
            if (this.config.footerLogo || this.config.footerBg) {
                // 异步创建底部模块
                const module = yield createFooterModule(this.config);
                if (module) {
                    // 返回创建的模块
                    return module;
                }
 ...
 */
export function createH5Prototype(config) {
    return __awaiter(this, void 0, void 0, function* () {
