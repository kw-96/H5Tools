...
exports.generateChannelVersion = generateChannelVersion;
...
class ChannelPrototypeGenerator {
    ...
    async clonePrototype() {
        try {
            ...
            // 4. 添加到当前页面
            figma_utils_1.NodeUtils.safeAppendChild(figma.currentPage, clonedPrototype, `${this.channel}渠道原型添加`);
    ...
    clearFooterLogo(footerFrame) {
        try {
            ...
            if (logoNode) {
                figma_utils_1.NodeUtils.safeRemoveNode(logoNode, '清除尾版LOGO');
    ...
    clearContainerContent(container) {
        try {
            ...
            children.forEach(child => {
                figma_utils_1.NodeUtils.safeRemoveNode(child, `清除${container.name}子节点`);
            });
    ...
    async insertEggBreakingImage(container, channel) {
        try {
            ...
            if (eggBreakingData) {
                ...
                figma_utils_1.NodeUtils.safeAppendChild(container, imageNode, '砸蛋样式图片添加');
                ...
                eggImage.x = 108;
                eggImage.y = 150;
                eggImage.fills = [figma_utils_1.ColorUtils.createSolidFill({ r: 0.9, g: 0.8, b: 0.7 })];
                figma_utils_1.NodeUtils.safeAppendChild(container, eggImage, '砸蛋样式占位图片添加');
    ...
    async createDrawContainer(mainContainer, nineGridFrame) {
        try {
            const drawContainer = figma_utils_1.NodeUtils.createFrame('立即抽奖', 512, 133);
            ...
            if (buttonImage) {
                ...
                figma_utils_1.NodeUtils.safeAppendChild(drawContainer, buttonImage, '立即抽奖按钮图片添加');
            }
            // 获取下载按钮的文本样式
            ...
            try {
                ...
                if (buttonTextStyle) {
                    ...
                    drawText.fills = [figma_utils_1.ColorUtils.createSolidFill({ r: 1, g: 1, b: 1 })];
                }
                ...
                figma_utils_1.NodeUtils.safeAppendChild(drawContainer, drawText, '立即抽奖文本添加');
            }
            catch (textError) {
                console.error('创建文本节点失败:', textError);
                // 即使文本创建失败，也继续执行后续代码
            }
            figma_utils_1.NodeUtils.safeAppendChild(mainContainer, drawContainer, '立即抽奖容器添加');
    ...
    async createMyPrizesContainer(mainContainer, drawContainer, nineGridFrame) {
        try {
            const myPrizesContainer = figma_utils_1.NodeUtils.createFrame('我的奖品', 398, 112);
            ...
            if (drawContainer) {
                ...
                if (buttonImage) {
                    ...
                    figma_utils_1.NodeUtils.safeAppendChild(myPrizesContainer, buttonImage, '我的奖品按钮图片添加');
                }
            }
            // 获取下载按钮的文本样式
            const buttonTextStyle = this.getDownloadButtonTextStyle(nineGridFrame);
            ...
            try {
                ...
                if (buttonTextStyle) {
                    ...
                    prizesText.fills = [figma_utils_1.ColorUtils.createSolidFill({ r: 1, g: 1, b: 1 })];
                }
                ...
                figma_utils_1.NodeUtils.safeAppendChild(myPrizesContainer, prizesText, '我的奖品文本添加');
            }
            catch (textError) {
                console.error('创建我的奖品文本失败:', textError);
            }
            figma_utils_1.NodeUtils.safeAppendChild(mainContainer, myPrizesContainer, '我的奖品容器添加');
    ...
    async createRulesContainer(mainContainer, myPrizesContainer, nineGridFrame) {
        try {
            const rulesContainer = figma_utils_1.NodeUtils.createFrame('活动规则', 398, 112);
            ...
            if (myPrizesContainer) {
                ...
                if (buttonImage) {
                    ...
                    figma_utils_1.NodeUtils.safeAppendChild(rulesContainer, buttonImage, '活动规则按钮图片添加');
                }
            }
            // 获取下载按钮的文本样式
            const buttonTextStyle = this.getDownloadButtonTextStyle(nineGridFrame);
            ...
            try {
                ...
                if (buttonTextStyle) {
                    ...
                    rulesText.fills = [figma_utils_1.ColorUtils.createSolidFill({ r: 1, g: 1, b: 1 })];
                }
                ...
                figma_utils_1.NodeUtils.safeAppendChild(rulesContainer, rulesText, '活动规则文本添加');
            }
            catch (textError) {
                console.error('创建活动规则文本失败:', textError);
            }
            figma_utils_1.NodeUtils.safeAppendChild(mainContainer, rulesContainer, '活动规则按钮添加');
        }
        catch (error) {
    ...
    async insertFooterStyleImage(footerFrame, channel) {
        try {
            ...
            if (footerStyleData) {
                ...
                figma_utils_1.NodeUtils.safeAppendChild(footerFrame, imageNode, '尾版样式图片添加');
                ...
                footerStyleImage.fills = [figma_utils_1.ColorUtils.createSolidFill({ r: 0.8, g: 0.9, b: 0.8 })];
                figma_utils_1.NodeUtils.safeAppendChild(footerFrame, footerStyleImage, '尾版样式占位图片添加');
