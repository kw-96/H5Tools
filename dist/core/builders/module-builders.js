...
class ActivityRulesModuleBuilder {
    ...
    addTitle() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const result = yield createTitleContainer(this.content.rulesTitle, (_a = this.content.rulesBgImage) !== null && _a !== void 0 ? _a : undefined, // 如果规则标题背景图片为空，则使用undefined
            1080, 120, this.currentY, {
                fontSize: 48,
                fontWeight: 'Bold',
...
export class NineGridModuleBuilder {
    ...
    addTitle() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const result = yield createTitleContainer(this.content.mainTitle, (_a = this.content.titleBgImage) !== null && _a !== void 0 ? _a : undefined, // null转undefined，防止类型报错
            1080, 120, this.currentY, {
                fontSize: 48,
                fontWeight: 'Bold',
                textColor: { r: 1, g: 1, b: 1 },
...
export class CarouselModuleBuilder {
    ...
    addTitleContainer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield createTitleContainer(this.content.title, (_a = this.content.titleBackground) !== null && _a !== void 0 ? _a : undefined, 1080, 120, 0, // 假设有currentY用于布局链
            {
                fontSize: 48,
                fontWeight: 'Bold',
                textColor: { r: 1, g: 1, b: 1 },
...
export class ActivityContentBuilder {
    ...
    addMainTitle() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.content.mainTitleBg || !this.content.mainTitle)
                return;
            console.log('添加大标题...');
            const result = yield createTitleContainer(this.content.mainTitle, (_a = this.content.mainTitleBg) !== null && _a !== void 0 ? _a : undefined, 1080, 120, 0, // 没有currentY，直接传0
            {
                fontSize: 48,
                fontWeight: 'Bold',
                textColor: { r: 1, g: 1, b: 1 },
    ...
    // 添加小标题
    addSubTitle() {
        return __awaiter(this, arguments, void 0, function* (startY = 0) {
            var _a;
            // 如果没有小标题背景或小标题文本，则不创建小标题容器
            if (!this.content.subTitleBg || !this.content.subTitle)
                return;
            console.log('添加小标题...');
            const result = yield createTitleContainer(this.content.subTitle, (_a = this.content.subTitleBg) !== null && _a !== void 0 ? _a : undefined, 1080, 100, startY, // 让小标题紧贴大标题容器
            {
                fontSize: 44,
                fontWeight: 'Medium',
                textColor: { r: 1, g: 1, b: 1 },
...
export class SignInModuleBuilder {
    ...
    addTitle() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.content.title && !this.content.titleImage)
                return;
            const result = yield createTitleContainer(this.content.title, // 标题文本
            (_a = this.content.titleImage) !== null && _a !== void 0 ? _a : undefined, // 标题背景（图片）
            1080, // 宽度
            120, // 高度
            0, // currentY
            {
...
export class VerticalCarouselModuleBuilder {
    ...
    addTitleContainer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield createTitleContainer((_a = this.content.title) !== null && _a !== void 0 ? _a : undefined, // 标题文本
            (_b = this.content.titleBackground) !== null && _b !== void 0 ? _b : undefined, // 标题背景图片
            1080, // 宽度
            120, // 高度
            0, // currentY
            {
