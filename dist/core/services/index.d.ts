...
export declare class ServiceManager {
    static readonly config: typeof ConfigService;
    static readonly theme: typeof ThemeService;
    static readonly channelImage: typeof ChannelImageService;
    static readonly validation: typeof ValidationService;
